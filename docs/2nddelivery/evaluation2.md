...
> However, Our initial approach is **Oversampling** : we don't know yet what is the *best sampling rate*, we need more testing to understand how dynamic can be our phenomena
